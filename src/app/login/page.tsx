...
export default function LoginPage() {
  ...
  return (
    <div className="flex-center animate-fade-in bg-cream-pattern" style={{ minHeight: "100vh", padding: "2rem", backgroundColor: "var(--college-bg-cream)", colorScheme: "light" }}>
      <div className="auth-card" style={{ width: "100%", maxWidth: "440px", padding: "3rem 2.5rem", border: "1px solid rgba(27, 94, 32, 0.12)", backgroundColor: "#ffffff", colorScheme: "light" }}>
