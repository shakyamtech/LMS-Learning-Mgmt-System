    ...
    <div style={{ minHeight: "100vh", backgroundColor: "var(--college-bg-cream)" }}>
      ...
      <section style={{ backgroundColor: "white", padding: "6rem 5rem" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <div>
            ...
            <Link href="/register" style={{ padding: "0.9rem 2rem", backgroundColor: "var(--college-primary)", color: "white", textDecoration: "none", fontWeight: "bold", borderRadius: "4px", display: "inline-block", transition: "all 0.3s" }}>
              Join Our Community →
            </Link>
          </div>
          <div style={{ position: "relative" }}>
            <img src="/hero2.png" alt="Students at Lagankhel IT Academy" style={{ width: "100%", borderRadius: "12px", objectFit: "cover", height: "420px", boxShadow: "0 20px 50px rgba(0,0,0,0.12)" }} />
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem" }}>
            {[
              ...
              <div key={i} style={{ backgroundColor: "white", borderRadius: "12px", padding: "2.5rem", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", borderTop: "4px solid var(--college-accent)" }}>
      ...
      <section style={{ backgroundColor: "white", padding: "6rem 5rem" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem" }}>
            {team.map((member, i) => (
              <div key={i} style={{ textAlign: "center", padding: "2rem", borderRadius: "12px", backgroundColor: "var(--college-bg-cream)", transition: "transform 0.3s, box-shadow 0.3s" }}>
                <img src={member.avatar} alt={member.name} style={{ width: "110px", height: "110px", borderRadius: "50%", objectFit: "cover", border: "4px solid var(--college-accent)", marginBottom: "1rem", boxShadow: "0 4px 14px rgba(0,0,0,0.12)" }} />
